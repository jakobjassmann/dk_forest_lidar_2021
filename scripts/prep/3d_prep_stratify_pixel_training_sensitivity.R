...
save(pixel_training_biowide, 
     file = "data/training_data/pixel_training_biowide_sensitivity.Rda")
save(pixel_valid_biowide,
     file = "data/training_data/pixel_valid_biowide_sensitivity.Rda")
...
save(pixel_training_derek, 
     file = "data/training_data/pixel_training_derek_sensitivity.Rda")
save(pixel_valid_derek,
     file = "data/training_data/pixel_valid_derek_sensitivity.Rda")
