...
# Calculate performances for validation data
...
# Calculate performances for training data
performance_biowide_overall_training <- predict(rf_biowide, 
...
Variable importance for this random forest model, determined using the 
"permutation" option in ranger. 
...
performance_derek_overall_training <- predict(rf_derek, 
