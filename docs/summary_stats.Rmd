...
This document provides summary stats (area) for the forest quality projections.
...
2. Training data area: High quality and low quality forests.
...
## Training data area: High quality and low quality forests

Here you can see the area covered by our training data. Including both the
high quality forests with designations (p15, p25 and private old growth), as well as the 
low quality training polygons. The proportions are given relative to the total area of
