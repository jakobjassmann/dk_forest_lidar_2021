...
quality forests. This overlap included duplicate mappings within each category, as well as some
...
First, we removed all internal overlap within the high quality geometries. For this
...
the same approach as for the high quality geometries except working in prescribed order (the polygons were simpely processed in the order they were loaded). 
...
The resulting dataset consisted of two type of forest annotations (8915 high and 9720 low quality polygons)
