---
title: "DK Forest LiDAR - By Pixel Projections"
...
# DK Forest LiDAR - By Pixel Projections of Forest Quality 
...
leaflet() %>% 
  ...
  addProviderTiles(providers$Esri.WorldImagery, group = "Sattelite (ESRI)") %>%
  addRasterImage(forest_qual, colors = pal, opacity = 0.8) %>%
  ...
  addLayersControl(
    baseGroups = c("Open Street Map", "Sattelite (ESRI)"),
    overlayGroups = c("Projections"),
